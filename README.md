...
- [x] User can click links in tweets which will launch in the web browser 
...
- [X] User can visit other parts of the app such as messages, search and notifications using the bottom navigation bar just as in the Twitter app
- [X] Leveraged Fragments to present different screens within the app

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='walkthrough_091821.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
